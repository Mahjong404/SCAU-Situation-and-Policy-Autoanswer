...
with open("chaoxing_solution_of_font_confusion/HanSansCN_glyfHashedTables.pkl", "rb") as f:
    glyfHashed = pickle.load(f)[0]

with open("chaoxing_solution_of_font_confusion/HanSansCN_CmapTables.pkl", "rb") as f:
    cmap = pickle.load(f)
